...
//            this.ar = new Animation(sprite_two, 1200);
        ...
        this.menu_one = new DropdownMenu(new Layout(this.getX() + offSet, -300, 250, 500), "Archer", MenuType.MENU_DARK, this);
        this.menu_one.setActive(true);

        this.menu_two = new DropdownMenu(new Layout(this.menu_one.getX() + this.menu_one.getWidth() + 20, -300, 250, 500), "Coming soon..", MenuType.MENU_DARK, this);
        this.menu_two.setActive(true);

        this.menu_three = new DropdownMenu(new Layout(this.menu_two.getX() + this.menu_two.getWidth() + 20, -300, 250, 500), "Coming soon..", MenuType.MENU_DARK, this);
